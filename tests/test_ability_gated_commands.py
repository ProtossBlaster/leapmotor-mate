...
def test_ability_gate_is_model_blind():
    ...
    # 53 is BLE_KEY_RESTART in leapmotor-api, not the charge-gun unlock: it must not show the button.
    assert cp.command_shown("VIN", "unlock_charger", abilities=[53]) is False
